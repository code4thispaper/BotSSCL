...
def run(dataset, input_embedding_dimension, output_embedding_dimension, epochs):
    ...
    torch.save(model, f"aug1/pretrained_model/model_{input_embedding_dimension}x{output_embedding_dimension}_{dataset}_{epochs}.pt")
    ...
    ax.set_xlabel("epoch")
    ax.set_ylabel("loss")
    fig.savefig(f'aug1/loss/loss_{input_embedding_dimension}x{output_embedding_dimension}_{dataset}_{epochs}.png', bbox_inches='tight', dpi=300)
    ...
    fig.savefig(f'aug1/tsne/tsne_train_embeddings_{input_embedding_dimension}x{output_embedding_dimension}_{dataset}_{epochs}.png', bbox_inches='tight', dpi=300)
    plt.legend()
    ...
    ax.scatter(reduced[~positive, 0], reduced[~positive, 1], label="negative")
    plt.legend()
    fig.savefig(f'aug1/tsne/tsne_test_embeddings_{input_embedding_dimension}x{output_embedding_dimension}_{dataset}_{epochs}.png', bbox_inches='tight', dpi=300)
    ...
    ax.scatter(reduced[~positive, 0], reduced[~positive, 1], label="negative")
    plt.legend()
    fig.savefig(f'aug1/tsne/tsne_train_data_{input_embedding_dimension}x{output_embedding_dimension}_{dataset}_{epochs}.png', bbox_inches='tight', dpi=300)
    ...
    ax.scatter(reduced[~positive, 0], reduced[~positive, 1], label="negative")
    plt.legend()
    fig.savefig(f'aug1/tsne/tsne_test_data_{input_embedding_dimension}x{output_embedding_dimension}_{dataset}_{epochs}.png', bbox_inches='tight', dpi=300)
    ...
    with open(f"epoch_experiments/{dataset}_{input_embedding_dimension}_{output_embedding_dimension}_{epochs}.json", "w") as f:
