...
def tweet_extracted_features(timeline_file, date_scraped):
    ...
    timeline_info['statuses_count'] = data[0]['user']['statuses_count']
    timeline_info['profile_use_background_image'] =  data[0]['user']['profile_use_background_image']
    ...
    timeline_info['tweet_frequency'] = timeline_info['statuses_count'] / \
