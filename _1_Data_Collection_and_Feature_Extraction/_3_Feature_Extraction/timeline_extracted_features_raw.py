...
def generate_df(data):
    ...
    df['favourites_count'] = no_retweets
...
def tweet_extracted_features(timeline_file, date_scraped):
    ...
    agg_tweets = "\n".join(df['tweet'])
    agg_valence_scores = find_tweet_valence(agg_tweets, analyser)
...
if __name__ == "__main__":
    ...
    df.to_csv("timeline_raw.csv", index=False)
